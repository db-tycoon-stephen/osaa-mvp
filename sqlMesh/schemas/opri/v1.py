"""OPRI Schema Version 1 - Initial schema definition.

This is the initial schema for OPRI indicators, containing core fields
for tracking policy research indicators.
...
OPRI_V1_METADATA = {
    ...
    "created_by": "system",
    "description": "Initial OPRI schema with core indicator fields",
